...
class MultilanguageSettingTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        foreach($this->getSupportedLanguage() as $locale => $detail){
            $multilanguage = MultilanguageSetting::create([
                'locale'    => $locale,
                'is_enable' => $locale == 'en'
            ]);

            $multilanguage->detail()->create($detail);
        }
    }

    private function getSupportedLanguage()
    {
        return [
